      ...
      <div className="mb-2">
        ...
        >
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <Link to={"/register"}>
            <button type="button" className="cursor-pointer text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 w-32">Inquire Now</button>
            </Link>
