...
<div className="flex items-center justify-center mx-auto  max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 w-full h-full">
    <form className="max-w-sm mx-auto" onSubmit={handleSubmit(onclick)}>
      ...
      <div className="mb-5">
        ...
        <input
          ...
          {...register("confirm_password",{
            required:"This is required",
            validate:(value)=>
              value===watch("password") || "Passwords do not match each other."
          })}
        />
      </div>
      {errors.confirm_password && <p className='text-red-600 mb-2'>{errors.confirm_password.message}</p>}
      ...
      <Link to="/login"> <p className='dark:text-white hover:underline'>Already Have An Account?</p> </Link>
      <p className="dark:text-white">Other Login Methods</p>
