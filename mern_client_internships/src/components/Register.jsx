          ...
          <form className="max-w-sm mx-auto" onSubmit={handleSubmit(onclick)}>
            ...
            <div className="my-2 grid grid-cols-3">
              <div>
                <button
                  type="button"
                  className="flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-xl cursor-pointer shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                >
                  <svg
              ...
              <div>
                <button
                  type="button"
                  className="flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-xl cursor-pointer shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 h-full"
                >
                  <svg
                    width="20"
                    height="20"
